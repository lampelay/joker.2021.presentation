...
В рамках Сбера, а точнее в рамках бэковой части Сбербанк-Онлайн, мы как раз работаем над таким BOM-артефактом, в котором собираем сторонние библиотеки и внутренние библиотеки для работы с платформой Сбера.
